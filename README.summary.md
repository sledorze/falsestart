...
— `.github/hooks/*.json` — and needs `--agent copilot`; see `docs/using-the-hook.md`, which also
carries the check for the two registrations drifting apart, since falsestart reads neither of them.
Choose the preset
